...
//        Student student123 = context.getBean(Student.class);
        ...
        org.crayzer.spring.spring02.Klass class1 = context.getBean(org.crayzer.spring.spring02.Klass.class);
        System.out.println(class1);
        System.out.println("Klass对象AOP代理后的实际类型："+class1.getClass());
        System.out.println("Klass对象AOP代理后的实际类型是否是Klass子类："+(class1 instanceof org.crayzer.spring.spring02.Klass));
