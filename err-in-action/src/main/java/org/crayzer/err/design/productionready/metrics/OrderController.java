...
public class OrderController {
    ...
    /**
     * 使用合法的用户 ID 和营业的商户 ID => wrk -t 1 -c 1 -d 3600s http://localhost:45678/order/createOrder?userId=20&merchantId=2
     * 模拟无效用户 ID 运行一段时间 => wrk -t 1 -c 1 -d 3600s http://localhost:45678/order/createOrder?userId=2&merchantId=2
     * 尝试一下因为商户不营业导致的下单失败 => wrk -t 1 -c 1 -d 3600s http://localhost:45678/order/createOrder?userId=20&merchantId=1
     */
